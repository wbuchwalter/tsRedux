...
/***/ function(module, exports, __webpack_require__) {
	...
	var todoAdder_1 = __webpack_require__(8);
	var todoLister_1 = __webpack_require__(9);
	var todoActions_1 = __webpack_require__(10);
	var redux = __webpack_require__(12);
	angular.module('app', [])
	    .factory('reduxStore', function () {
	    var reducer = redux.combineReducers(reducers);
	    return redux.createStore(reducer);
	})
	    .factory('todoActions', todoActions_1.default)
	    .directive('todoAdder', todoAdder_1.default)
	    .directive('todoLister', todoLister_1.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var todo_1 = __webpack_require__(5);
	exports.todoReducer = todo_1.default;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var actionTypes_1 = __webpack_require__(6);
	var jquery = __webpack_require__(7);
	var initialState = { todos: [], idCounter: 0 };
...
/***/ function(module, exports) {
	...
	exports.default = todoAdder;
	var TodoAdderController = (function () {
	    function TodoAdderController(todoActions, reduxStore) {
	        this.todoActions = todoActions;
	        this.reduxStore = reduxStore;
	        this.id = 0;
	    }
	    TodoAdderController.prototype.click = function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = todoAdder;
	var TodoListerController = (function () {
	    function TodoListerController(reduxStore) {
	        this.reduxStore = reduxStore;
	    ...
	    TodoListerController.prototype.onStoreChanged = function () {
	        var todoReducerState = this.reduxStore.getState().todoReducer;
	        this.todos = jquery.extend(true, {}, todoReducerState.todos);
	    };
	    return TodoListerController;
	})();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var actionCreators = __webpack_require__(11);
	var redux = __webpack_require__(12);
	function todoActionsService(reduxStore) {
	    return redux.bindActionCreators(actionCreators, reduxStore.dispatch);
	}
	exports.default = todoActionsService;
